...
export function TabBar({ paneId, tabs, activeId, onActivate, onClose }: TabBarProps) {
    ...
    return (
        <div
            ref={scrollerRef}
            className='flex w-full min-w-0 items-center gap-1 overflow-x-auto overflow-y-hidden px-1 pt-1'
...
function SortableTab({ paneId, tab, active, onActivate, onClose }: SortableTabProps) {
    ...
    return (
        <div
            ...
            className={cn(
                'group/tab inline-flex h-7 shrink-0 items-center gap-1 rounded-md px-2 text-[0.75rem] leading-none select-none',
